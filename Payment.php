...
<body>
  ...
  <section data-bs-version="5.1" class="clients1 cid-ttQ92a9ouh" id="clients1-1b">
    
    <div class="images-container container-fluid">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-1">Payment Successful</h3>
            
            <p class="mbr-text mbr-fonts-style align-center mt-2 display-5"><strong><em>
                Redirecting.... </em></strong></p>
        </div>
        <div class="row justify-content-center mt-4">
            <div class="col-md-3 card">
                <img src="assets/images/mbr-240x201.png" alt="">
            </div>
